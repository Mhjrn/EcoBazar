...
function FeaturedProduct() {
  ...
  const FeProducts = products.filter(
    (products) =>
     products.subcategory && products.subcategory.includes("Featured Products"));

  return (
    <>
    <div className="container mx-auto px-28 py-[60px] ">
      ...
      {/* product list start */}
      <div className="grid grid-cols-5 items-center my-[30px] gap-0">
        {FeProducts.map((elem, index) => (
        <div className=" h-[327px] border-[1px] border-gray-100  hover:border-[#2C742F] hover:shadow-lg">
          ...
          <div className="w-[264px] h-[87px] gap-[6px]  place-content-center p-[12px]">
            <div className="grid grid-flow-col justify-between">
              <div>
